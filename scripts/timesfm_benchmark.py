...
def main():
    ...
    parser.add_argument("--cache", type=Path, default=ROOT / ".autoresearch/timesfm/forecasts.db")
    parser.add_argument("--output", type=Path, default=ROOT / ".autoresearch/timesfm")
